 ...
 * generated in the main.java.ru.genereted.v1.fileoperationsln package.
...
public class ObjectFactory {
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: main.java.ru.genereted.v1.fileoperationsln
     *
     */
    ...
    /**
     * Create an instance of {@link ROW.HOSPITALBREACH }
     *
     */
    public ROW.HOSPITALBREACH createROWHOSPITALBREACH() {
        return new ROW.HOSPITALBREACH();
    }

    /**
     * Create an instance of {@link ROW.TREATPERIODS }
     *
     */
    public ROW.TREATPERIODS createROWTREATPERIODS() {
        return new ROW.TREATPERIODS();
    }

    /**
     * Create an instance of {@link ROW.LNRESULT }
     *
     */
    public ROW.LNRESULT createROWLNRESULT() {
        return new ROW.LNRESULT();
    }
