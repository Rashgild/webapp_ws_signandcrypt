...
public class FileOperationsLnService_Service extends Service {
    ...
    public FileOperationsLnService_Service() {
        super(__getWsdlLocation(), FILEOPERATIONSLNSERVICE_QNAME);
    }

    public FileOperationsLnService_Service(WebServiceFeature... features) {
        super(__getWsdlLocation(), FILEOPERATIONSLNSERVICE_QNAME, features);
    }

    public FileOperationsLnService_Service(URL wsdlLocation) {
        super(wsdlLocation, FILEOPERATIONSLNSERVICE_QNAME);
    }

    public FileOperationsLnService_Service(URL wsdlLocation, WebServiceFeature... features) {
        super(wsdlLocation, FILEOPERATIONSLNSERVICE_QNAME, features);
    }

    public FileOperationsLnService_Service(URL wsdlLocation, QName serviceName) {
        super(wsdlLocation, serviceName);
    }

    public FileOperationsLnService_Service(URL wsdlLocation, QName serviceName, WebServiceFeature... features) {
