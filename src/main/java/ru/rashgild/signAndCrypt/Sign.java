...
public class Sign {
    ...
    public static SOAPMessage signationByParametrs(SOAPMessage soapMessage, String Actor, String Refer, String Alias,
        ...
        X509Certificate cert = CertificateUtils.getCertificateFromKeyStorage(Alias);
        PrivateKey privateKey = CertificateUtils.getPrivateKey(Password, Alias);
    ...
    public static SOAPMessage signation() {
        ...
        try {
            ...
            PrivateKey privateKey = CertificateUtils.getPrivateKey(GlobalVariables.moPass, GlobalVariables.moAlias);
