...
public class JSONGen {
    ...
    /**
     * @param SQL
     * @return SQL="select num1,num2 from numbers" was returning list of lists with num1 and num2
     */
    ...
    /**
     * @param SQL-request
     * @return SQL="select num1 as Num1,num2 as Num2 from numbers" was returning json
     */
    ...
    public String getJson() throws JSONException {
        ...
        } catch (IOException | CanonicalizationException | SOAPException | InvalidCanonicalizerException | SAXException | ParserConfigurationException e) {
            e.printStackTrace();
        }
        return null;
    }
